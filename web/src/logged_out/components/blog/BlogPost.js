...
import ShareButton from "../../../components/shared/components/ShareButton";
import ZoomImage from "../../../components/shared/components/ZoomImage";
...
function BlogPost(props) {
  ...
  useEffect(() => {
    document.title = `Stellar Foundries - ${title}`;
    smoothScrollTop();
  }, [title]);
