...
import ConsecutiveSnackbarMessages from "../../components/shared/components/ConsecutiveSnackbarMessages";
import smoothScrollTop from "../../components/shared/functions/smoothScrollTop";
...
function Main(props) {
  ...
  const selectDashboard = useCallback(() => {
    smoothScrollTop();
    document.title = "Stellar Foundries - Dashboard";
    setSelectedTab("Dashboard");
    if (!hasFetchedCardChart) {
      setHasFetchedCardChart(true);
      import("../../components/shared/components/CardChart").then((Component) => {
  ...
  const selectSubscription = useCallback(() => {
    smoothScrollTop();
    document.title = "Stellar Foundries - Subscription";
